...
**Текущий этап**: 0c (в работе — стартовали 2026-05-18)
...
| 0c — VPS setup + миграция n8n с Railway | 🟡 In progress (2026-05-18) | — | **В работе.** Задачи T0.10-T0.20. См. §7 (инфра), §12 (безопасность). |
...
4. Перед финальным коммитом в main — напомнить про /ultrareview
